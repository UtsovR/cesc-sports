import { Shield, Award, MessageSquare, Heart, Lightbulb, Music } from 'lucide-react';
            ...
            <div className="max-w-7xl mx-auto">
                ...
                <div className="mb-24">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-4xl mx-auto">
                        {leadership.slice(0, 2).map((member, index) => (
                            <div
                                key={index}
                                className="group relative bg-white/80 backdrop-blur-md rounded-2xl p-8 border border-blue-100 shadow-xl hover:shadow-2xl transition-all duration-300 hover:-translate-y-1 flex flex-col items-center text-center ring-1 ring-blue-50"
                            >
                                ...
                                <p className="text-blue-700 font-bold uppercase tracking-wider text-sm">{member.role}</p>
                            </div>
                        ))}
                    </div>
                </div>
